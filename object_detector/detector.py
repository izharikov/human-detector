...
import cv2
from object_detector.configuration import *
...
visualize = False
normalize = True
data_path='/home/igor/university/machine-learning/human-detector/data'
pos_feat_ph = data_path + '/features/pos'
neg_feat_ph = data_path + '/features/neg'
